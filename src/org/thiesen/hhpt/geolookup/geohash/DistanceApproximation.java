...
public class DistanceApproximation
{
  ...
  public void setTestPoint(final double lat, final double lng)
  {
    m_testLat = lat;
    m_testLng = lng;
  ...
  public double getDistanceSq(final double lat, final double lng)
  {
    final double latMiles = (lat - m_testLat) * MILES_PER_LATITUDE;
    ...
    final double lngMiles = (lng - m_testLng) * m_mpd;
  ...
  //    the test position
  public double getDistanceSq(final double lat1, final double lng1, final double lat2, final double lng2)
  {
     ...
     final double v1y = lat2 - lat1;
     final double v1x = lng2 - lng1;
     final double v2y = m_testLat - lat1;
     final double v2x = m_testLng - lng1;
     ...
     final double c = dot / (v1x * v1x + v1y * v1y);
     if (c >= 1.0f)
  ...
  public static double getMilesPerLngDeg(final double lat)
  {
